...
const arInvoiceRoutes = require('./routes/arInvoice.routes');
const customerPaymentRoutes = require('./routes/customerPayment.routes');
const arAgingRoutes = require('./routes/arAging.routes');
const arCreditNoteRoutes = require('./routes/arCreditNote.routes');
const customerReturnRoutes = require('./routes/customerReturn.routes');
...
app.use('/api/ar/payments', customerPaymentRoutes);
